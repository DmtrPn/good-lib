...
(function (DateFormat) {
    // @ts-ignore H:mm:ss
    DateFormat["Time"] = "H:mm:ss";
    // @ts-ignore dd.MM.yyyy
    DateFormat["DateWithDotSeparator"] = "dd.MM.yyyy";
    // @ts-ignore dd MMMM yyyy
    DateFormat["DateWithMonthString"] = "dd MMMM yyyy";
    // @ts-ignore yyyy-MM-dd
    DateFormat["DateWithDashSeparator"] = "yyyy-MM-dd";
    // @ts-ignore dd/MM/yy
    DateFormat["DateWithSlashSeparator"] = "dd/MM/yy";
    // @ts-ignore dd.MM.yyyy H:mm
    // tslint:disable-next-line:max-line-length
    DateFormat["DateWithTime"] = "dd.MM.yyyy H:mm";
    // @ts-ignore EEEEEE,d
    DateFormat["WeekDayWithDay"] = "EEEEEE,d";
    // @ts-ignore dd MMMM
    DateFormat["DayWithMonthString"] = "dd MMMM";
